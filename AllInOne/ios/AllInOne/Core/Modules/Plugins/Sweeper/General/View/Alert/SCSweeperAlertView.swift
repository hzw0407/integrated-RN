...
typealias SCSweeperAlertViewCancelBlock = () -> Void
typealias SCSweeperAlertViewConfirmBlock = () -> Void
typealias SCSweeperAlertViewTextConfirmBlock = (_ text: String) -> Void

class SCSweeperAlertView: NSObject {
    ...
    private var cancelBlock: SCSweeperAlertViewCancelBlock?
    private var confirmBlock: SCSweeperAlertViewConfirmBlock?
    private var textConfirmBlock: SCSweeperAlertViewTextConfirmBlock?
    ...
    fileprivate static let sharedInstance = SCSweeperAlertView()
...
//        self.textConfirmBlock = nil
    ...
    static func alertTip(message: String, confirmTitle: String = tempLocalize("确定")) {
        SCSweeperAlertView.sharedInstance.alert(title: tempLocalize("提示"), message: message, confirmTitle: confirmTitle)
    }
    
    /// 普通弹窗,左边按钮为取消，右边按钮为确认
    static func alertDefault(title: String? = tempLocalize("提示"), message: String? = nil, supplement: String? = nil, cancelCallback: SCSweeperAlertViewCancelBlock? = nil, confirmCallback: SCSweeperAlertViewConfirmBlock? = nil) {
    ...
    static func alert(title: String? = nil, message: String? = nil, supplement: String? = nil, cancelTitle: String? = nil, confirmTitle: String?, confirmColor: UIColor? = nil, cancelCallback: SCSweeperAlertViewCancelBlock? = nil, confirmCallback: SCSweeperAlertViewConfirmBlock? = nil, isNeedManualHide: Bool = false) {
        SCSweeperAlertView.sharedInstance.alert(title: title, message: message, supplement: supplement, cancelTitle: cancelTitle, confirmTitle: confirmTitle, confirmColor: confirmColor, cancelCallback: cancelCallback, confirmCallback: confirmCallback, isNeedManualHide: isNeedManualHide)
    }
    
    static func alertText(title: String? = nil, range: NSRange = NSRange(location: 1, length: 12), placeholder: String? = nil, content: String? = nil, supplement: String? = nil, cancelCallback: SCSweeperAlertViewCancelBlock? = nil, confirmCallback: SCSweeperAlertViewTextConfirmBlock? = nil, isNeedManualHide: Bool = false) {
    ...
    static func alertText(title: String? = nil, range: NSRange = NSRange(location: 1, length: 12), placeholder: String? = nil, content: String? = nil, supplement: String? = nil, cancelTitle: String? = nil, confirmTitle: String?, cancelCallback: (() -> Void)? = nil, confirmCallback: SCSweeperAlertViewTextConfirmBlock? = nil, isNeedManualHide: Bool = false) {
        SCSweeperAlertView.sharedInstance.alertText(title: title, range: range, placeholder: placeholder, content: content, supplement: supplement, cancelTitle: cancelTitle, confirmTitle: confirmTitle, cancelCallback: cancelCallback, confirmCallback: confirmCallback, isNeedManualHide: isNeedManualHide)
    }
    
    static func alert(title: String? = nil, customView: UIView, supplement: String? = nil, cancelTitle: String = tempLocalize("取消"), confirmTitle: String = tempLocalize("确定"), cancelCallback: SCSweeperAlertViewCancelBlock? = nil, confirmCallback: SCSweeperAlertViewConfirmBlock? = nil, isNeedManualHide: Bool = false) {
        SCSweeperAlertView.sharedInstance.alert(title: title, customView: customView, supplement: supplement, cancelTitle: cancelTitle, confirmTitle: confirmTitle, cancelCallback: cancelCallback, confirmCallback: confirmCallback, isNeedManualHide: isNeedManualHide)
    }
    

    
    static func hide() {
        if SCSweeperAlertView.sharedInstance.isNeedManualHide {
            SCSweeperAlertView.sharedInstance.isNeedManualHide = false
        }
        SCSweeperAlertView.sharedInstance.hide()
    }
    
    fileprivate func alert(title: String? = nil, message: String? = nil, supplement: String? = nil, cancelTitle: String? = nil, confirmTitle: String? = nil, confirmColor: UIColor? = nil, cancelCallback: SCSweeperAlertViewCancelBlock? = nil, confirmCallback: (() -> Void)? = nil, isNeedManualHide: Bool = false) {
        self.hide()
        self.title = title
    ...
    fileprivate func alertText(title: String? = nil, range: NSRange = NSRange(location: 1, length: 12), placeholder: String? = nil, content: String? = nil, supplement: String? = nil, cancelTitle: String? = nil, confirmTitle: String?, cancelCallback: (() -> Void)? = nil, confirmCallback: SCSweeperAlertViewTextConfirmBlock? = nil, isNeedManualHide: Bool = false) {
        self.title = title
    ...
    fileprivate func alert(title: String? = nil, customView: UIView, supplement: String? = nil, cancelTitle: String? = nil, confirmTitle: String?, cancelCallback: SCSweeperAlertViewCancelBlock? = nil, confirmCallback: SCSweeperAlertViewConfirmBlock? = nil, isNeedManualHide: Bool = false) {
        self.title = title
